...
ALGORITMS = ["LREG", "DTC3", "DTC6", "DTC12", "GNB", "KNN", "RFC"]
ALGORITMS = ["DTC6", "DTC12", "GNB", "KNN", "RFC"]
PERIODS_INDICATORS = [5, 10, 20, 50,200]
PERIODS_RESULTS = [5, 10, 15, 20]
PERIODS_RESULTS = [20]
TRAIN_TEST_SPLIT_SIZES = [ 0.1, 0.2, 0.3]
...
ATRIBS_PER = ["EMA", "EMA-dist", "MACD", "MACD-DIFF", "MACD-SIGNAL", "RSI", "SO", "SOS", 
          "TSI", "BBH", "BBHI", "BBL", "BBLI", "BBP", "BBH-BBL-dist", #"BBH-dist" , "BBL-dist", 
          "FI", "SMA-LREG", "BBH-LREG", "BBL-LREG", "SO-LREG"] 
ATRIBS_RES = ["res",  "res-positive",  "res-perc"]
ATRIBS_REJECT = ["max", "min", "fibo-ret", "SMA", "SMA-dist", "BBH", "BBL", "EMA"]
...
DATA_YEAR_INIT=2012
DATA_YEAR_END=2023
DATA_TRAIN_DATE_INIT=20210101
DATA_TRAIN_DATE_END=20230101
...
DATA_PATH_CURRENCY=ROOT_PATH+"../currency/"
